...
function Get_Year (k: Year_Type) return integer;
function Get_Month (k: Year_Type) return integer;
function Get_day (k: Year_Type) return integer;

function "<" (L,R: Year_Type) return boolean;
function ">" (L,R: Year_Type) return boolean;
function "=" (L,R: Year_Type) return boolean;

private 

type Year_Type is array (1..3) of integer;
